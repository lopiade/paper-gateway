...
var _PaperResources = require('./components/PaperResources');

var _PaperResources2 = _interopRequireDefault(_PaperResources);
...
_vue2.default.config.debug = true; // turn on debugging mode
_vue2.default.config.silent = false; // turn on silent mode
...
new _vue2.default({
    ...
    components: {
        ...
        PaperResources: _PaperResources2.default
...
},{"./components/PaperResources":24,"vue":21,"vue-resource":6}],23:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    computed: {
        ...
        onlineLabel: function onlineLabel() {
        ...
        onlineIcon: function onlineIcon() {
    ...
    methods: {
        ...
        checkAvailability: function checkAvailability() {
            ...
            var resource = this.$resource('/api/resource{/id}');

            resource.save({ id: this.resource.context.id }, {}).then(function (response) {

                _this.resource.status = 'success';
                _this.resource.online = response.data.is_online;
            }, function () {

                _this.resource.status = 'failed';
            }).finally(function () {
                _this.loading = false;
            });
        },
         ...
         */
        onClickResource: function onClickResource() {
         ...
         * @private
         */
        _resourceIsClickable: function _resourceIsClickable() {
...
},{"./templates/paper-resource.html":25}],24:[function(require,module,exports){
'use strict';
...
var _PaperResource = require('./PaperResource');

var _PaperResource2 = _interopRequireDefault(_PaperResource);
...
exports.default = {
    ...
    components: {
        PaperResource: _PaperResource2.default
    },
     ...
     */
    methods: {
        initResources: function initResources() {
            var _this = this;
...
},{"./PaperResource":23,"./templates/paper-resources.html":26}],25:[function(require,module,exports){
module.exports = '\n<a @click="onClickResource" class="list-group-item clearfix" :class="statusClass" :style="clickable">\n    <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw pull-right" v-if="loading"></i>\n\n    <h4 class="list-group-item-heading" style="word-break: break-all">[[ resource.context.url ]]</h4>\n    <p class="list-group-item-text">\n\n        <span v-if="!loading">\n            <i class="fa fa-fw" :class="onlineIcon"></i>\n        </span>\n\n        [[ resource.context.type_description ]]\n\n        <span v-if="!loading">\n            [[ onlineLabel ]]\n        </span>\n\n    </p>\n\n</a>';
},{}],26:[function(require,module,exports){
module.exports = '\n<div class="text-left">\n    <div class="list-group">\n        <paper-resource :resource="resource" v-for="resource in resources"></paper-resource>\n    </div>\n</div>\n';
},{}]},{},[22]);

//# sourceMappingURL=paper-gateway.js.map
